...
```js
{
  ...
  // Список параметров из файла, доступных для редактирования.
  // Тип: массив объектов.
  // Обязательное поле.
  "parameters": [
}
...
Поле ***parameters*** описывает доступные опции на экране настроек. Представляет собой массив, каждый элемент которого объект с описанием опции. Опции имеют **четыре** типа:
{
  "OblivionIni": {
      "path": "%DOCUMENTS%\\oblivion.ini",
      "view": "sectional",
