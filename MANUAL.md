...
* `Аргументы запуска`. Задают дополнительные параметры запуска исполняемого файла игры. Подробнее в главе [**Аргументы запуска**](#Аргументы-запуска).
...
Доступные опции:
* `Кодировка файлов настроек`. Задает кодировку по умолчанию для файлов настроек. Кодировка используется при чтении и записи данных из файлов игровых настроек. Посмотреть список поддерживаемых кодировок можно
[здесь](https://github.com/ashtuchkin/iconv-lite/wiki/Supported-Encodings). По умолчанию `win1251`.
