...
Здесь расположены основные настройки программы. Содержит две основные группы настроек: `Настройки окна программы` и `Настройки запуска программ`. 
...
![Настройки запуска программ](https://live.staticflickr.com/65535/52287970410_03b4924113_o.jpg)

Её можно поделить на две подгруппы: **Запуск игры** и **Запуск программ**.
...
* `Исполняемый файл`. Задает путь к исполняемому файлу игры. Должен имень расширение `.exe` или `.lnk`. Путь к файлу имеет вид *%Переменная_пути%/Путь к файлу*. Более подробная информация о переменных путей ниже в разделе **`Ручная настройка конфигурационных файлов`**.
* `Аргументы запуска`. Задают дополнительные параметры запуска исполняемого файла игры. Более подробная информация ниже в разделе **`Ручная настройка конфигурационных файлов`**.

Подгруппа **Запуск программ** отвечает за настройку запуска других программ, а так же откритие папок. Для запуска этих программ используются кнопки, так же расположенные на главном экране, сразу за кнопкой запуска игры. Каждая программа имеет свою кнопку.
...
* `Аргументы запуска`. Задают дополнительные параметры запуска исполняемого файла.
...
Суть состоит в том, чтобы создать группы настроек для группировки их по назначениию, выбрать файлы, которые хранят в себе данные настроек игры, и затем создать опции игровых настроек на основе групп и файлов. Группы можно не создавать, тогда все опции будут в общем списке.

![Настройки запуска программ](https://live.staticflickr.com/65535/52289005377_02778a12c9_o.jpg)

![Настройки запуска программ](https://live.staticflickr.com/65535/52289980756_faf7707d0d_o.jpg)

![Настройки запуска программ](https://live.staticflickr.com/65535/52289981941_2c018b1301_o.jpg)

![Настройки запуска программ](https://live.staticflickr.com/65535/52289984241_8fc2109b28_o.jpg)

![Настройки запуска программ](https://live.staticflickr.com/65535/52289985346_6a08968111_o.jpg)

![Настройки запуска программ](https://live.staticflickr.com/65535/52290258239_54fe3285f2_o.jpg)
