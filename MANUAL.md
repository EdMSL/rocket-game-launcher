...
На главном экране располагается панель навигации, где отображаются кнопка запуска игры, кнопка настроек программы, кнопка перехода на экран настроек игры, если настройки были добавлены в файл игровых настроек, и пользовательские кнопки, если они были добавлены в файл конфигурации программы (о файлах игровых настроек и конфигурации программы информация ниже).
...
В верхней части экрана настроек располагается навигация по группам настроек, если они были созданы. Иначе здесь будет только кнопка "Назад" для перехода на главный экран. Ниже располагается блок настроек, который содержит следующие элементы\блоки: 
* *Переключатель профиля Mod Organizer*
* *Список опций текущей группы настроек*
* *Кнопки управления опциями и бэкапами*
...
В программе предусмотрена возможность создания бэкапов файлов, параметры из которых использованы в опциях. Проще говоря, это все файлы-элементы объекта ***gameSettingsFiles***. Бэкапы создаются по кнопке "Создать бэкап" на экране игровых настроек программы. Помимо этого бэкап можно создать из окна "Бэкапы", кнопка к которму расположена рядом с кнопкой "Создать бэкап".
В верхней части окна "Бэкапы" будет отображен список доступных бэкапов или сообщение об их отсутствии.
